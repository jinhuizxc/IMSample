package com.example.imsample.view;
...
public class MyViewHolder<MESSAGE extends IMessage>
    ...
    public MyViewHolder(View itemView, boolean isSender) {
        ...
        this.mDisplayNameTv = (TextView)itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_receiver_display_name);
        ...
        this.mMsgTv.setOnLongClickListener(new View.OnLongClickListener() {
            public boolean onLongClick(View view) {
                if(MyViewHolder.this.mMsgLongClickListener != null) {
                    MyViewHolder.this.mMsgLongClickListener.onMessageLongClick(view, message);
                }
